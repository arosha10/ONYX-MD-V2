...
const GITHUB_TOKEN = process.env.GITHUB_TOKEN || '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';

module.exports = {
  SESSION_ID: process.env.SESSION_ID || "qF0SRDbZ#9tx5giKmJV6dnVvg68--kYhkqS6cKsSS-lQCXEEOWvk",
